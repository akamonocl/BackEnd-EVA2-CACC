...
try {
    ...
    $imagenes_json = json_encode($imagenes_paths ?: ['https://via.placeholder.com/600x400?text=PNK+Inmobiliaria']);
    ...
    $stmt->bind_param(
        "sssiidddsssiiiiiiiiisi",  // 21 caracteres = 21 variables
        $tipoPropiedad,      // s
        $operacion,          // s
        $descripcion,        // s
        $banos,              // i
